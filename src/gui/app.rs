use super::{
    character_list::CharacterList, font_settings::FontSettings, header::Header,
...
impl HammerFontApp {
    pub fn new(creation_context: &eframe::CreationContext, localisation: Localisation) -> Self {
        ...
        Self {
            ...
            character_list: CharacterList::new(),
            localisation,
        }
    }
}
...
impl eframe::App for HammerFontApp {
    fn update(&mut self, context: &egui::Context, _frame: &mut eframe::Frame) {
        ...
        egui::SidePanel::right("character_list")
            .default_width(300.0)
            .show(context, |ui| {
                self.character_list.ui(ui, &self.localisation);
            });
    }
}
